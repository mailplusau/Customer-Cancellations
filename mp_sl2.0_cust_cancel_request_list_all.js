...
define([
	...
	function tabsSection() {
		...
		var serviceChangeTab = "active";
		var cancellationTab = "";

		if (runtime.getCurrentUser().id == 1807440) {
			serviceChangeTab = "";
			cancellationTab = "active";
		}
		...
		inlineHtml +=
			...
			serviceChangeTab +
			'"><a data-toggle="tab" href="#service_changes" style="border-radius: 30px"><b>SERVICE CHANGES</b></a></li>';
		inlineHtml +=
			'<li role="presentation" class="' +
			cancellationTab +
			'"><a data-toggle="tab" href="#cancellation" style="border-radius: 30px"><b>CANCELLATION</b></a></li>';
		...
		inlineHtml +=
			...
			serviceChangeTab +
			'" id="service_changes">';
		inlineHtml += dataTable("service_change_list");
		inlineHtml += "</div>";
		inlineHtml +=
			'<div role="tabpanel" class="tab-pane ' +
			cancellationTab +
	...
	function dataTable(name) {
		...
		inlineHtml +=
			...
			name +
			'" class="table table-responsive customer tablesorter cell-border compact" style="width: 100%;">';
	...
	function userDropdownSection(userId, saletype) {
		...
		inlineHtml +=
			'<div class="form-group container service_change_type_section hide">';
		inlineHtml += '<div class="row">';
		inlineHtml +=
			'<div class="col-xs-12 commencementtype"><div class="input-group"><span class="input-group-addon" id="commencementtype_text">Sale Type </span><select id="commencementtype" class="form-control commencementtype" ><option></option>';
		...
		resResult.forEach(function (res) {
			...
			if (listID == saletype) {
				inlineHtml +=
					'<option value="' + listID + '" selected>' + listValue + "</option>";
			} else if (
				listID == 13 ||
				listID == 21 ||
				listID == 7 ||
		...
		inlineHtml +=
			'<div class="col-xs-4"><input type="button" value="APPLY FILTER" class="form-control btn btn-primary" id="applyFilter" style="border-radius: 30px;" /></div>';
		inlineHtml += '<div class="col-xs-4"></div>';
		inlineHtml += "</div>";
		inlineHtml += "</div>";
